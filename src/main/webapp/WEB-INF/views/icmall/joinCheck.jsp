	...
	<form name="frm m-t-50">
		...
		<div class="div1">
			...
			<table>
				<tr>
					<!-- 첫번째 줄 시작 -->
					<td class="t1"><span class="f2">이용약관동의</span> <span id="f2"
						class="f2">*</span></td>

					<td><label class="lab" for="agree_all"> <input
				...
				<tr>
					...
					<td><span id="f3" style="font-size: 7px">선택항목에 동의하지 않은
							경우도 회원가입 및 일반적인 서비스웹 이용할 수 있습니다.</span> <br></td>
				</tr>
				<tr>
					<!-- 두번째 줄 시작 -->
					<td></td>
