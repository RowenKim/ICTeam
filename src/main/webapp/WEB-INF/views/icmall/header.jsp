...
<body>
 <!-- Body Inner -->
    <div class="body-inner" style="max-width:1200px; margin:auto;">
        <!-- Topbar -->
        <div id="topbar" class="d-xl-block d-lg-block topbar-fullwidth">
            <div class="container">
                <div class="row" >
                    <div class="col-md-9">
                   </div>
        ...
        <!-- end: Topbar -->
     <!-- Header -->
        <header id="header" data-fullwidth="true" style="max-width:1200px; margin:auto;">
