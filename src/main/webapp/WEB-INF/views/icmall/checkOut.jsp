				...
				<div class="shop-cart">
						...
						<div class="col-lg-12 no-padding">
							...
							<div class="row">
								...
								<hr>
								<input type="hidden" style="display:none;" name="p_name" value="${list.o_name }">
								<input type="hidden" style="display:none;" name="p_qty" value="${list.o_qty }">
							...
							<div class="row">
								...
								<div class="col-lg-9 form-group">
								<input onclick="" value="신용카드" type="radio" name="agree" class="basketChk" style="float:left; margin:6px 5px 0 0;" />
									<h5>신용카드</h5>
								...
								<div class="col-lg-9 form-group">
								<input onclick="" value="무통장 입금" type="radio" name="agree" class="basketChk" style="float:left; margin:6px 5px 0 0;" />
									<h5>계좌이체</h5>
