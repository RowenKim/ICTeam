...
<jsp:include page="header.jsp" />
	...
	<section id="page-content">
		<div class="content col-lg-14">
			...
			<br><br>
			<form name="frm" action="questionUpdateOk"" method="post" onsubmit="return chkSubmit()">
			<input type="hidden" name="proq_uid" value="${proqList[0].proq_uid }" />
			<table class="table">
				<tbody id="q_table">
					<tr>
						<th scope="row">제목</th>
						<td><input
							...
							type="text" value="${proqList[0].proq_title }"></td>
					</tr>
					<tr>
						...
						<td><textarea class="form-control required" name="proq_questionContent" rows="9"
							...
							aria-required="true">${proqList[0].proq_questionContent }</textarea></td>
					</tr>
				</tbody>
			</table>
			<h4>파일</h4>
